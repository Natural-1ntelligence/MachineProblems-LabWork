...
class BinaryTree
{
    public:
        ...
        void mirror(Node* root);                         //ADDED HELPER FN
        ...
        bool isOrderedIterative(Node* root) const;      //ADDED HELPER FN
        /**
        ...
        void isOrderedRecursive(Node* root, vector<T> &v)const;   //ADDED HELPER FN
        ...
        void getPaths(vector<vector<T> > &paths, Node* subRoot, vector<T> temp)const;    //ADDED HELPER FN
        ...
        int sumDistances() const;
         ...
         int sumDistances(Node *subRoot, int distance) const;                    //ADDED HELPER FN
